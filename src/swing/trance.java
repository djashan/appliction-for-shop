 ...
 * @author Ashan Pro
 */
public class trance extends javax.swing.JFrame {
      ...
      public void tableload()
    {
        ...
        try {
            String sql = "SELECT tid,tvehi,tnumber,dname,datetr,ttime from trance";
    ...
    private void initComponents() {
        ...
        tdatebox = new javax.swing.JTextField();
        jLabel20 = new javax.swing.JLabel();
        ttimebox = new javax.swing.JTextField();
        ...
        tnumberbox = new javax.swing.JTextField();
        tdrivbox = new javax.swing.JComboBox<>();
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/icons8_car_48px.png"))); // NOI18N
        ...
        jLabel3.setText("Tranceport Management");
        ...
        jPanel3.add(tidbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 130, 30));
        jPanel3.add(tnamebox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, 270, 30));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(153, 255, 255));
        jLabel17.setText("vehical");
        ...
        jLabel18.setText("Vehical Number");
        ...
        jLabel19.setText("Driver Name");
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, -1, -1));
        jPanel3.add(tdatebox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 300, 270, 30));
        ...
        jPanel3.add(ttimebox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 370, 270, 30));

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(153, 255, 255));
        jLabel21.setText("Time to Trip");
        jPanel3.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, -1, -1));
        ...
        jPanel3.add(tnumberbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 270, 30));

        tdrivbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nimal", "Kaml", "Amal", "Suranga" }));
        jPanel3.add(tdrivbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 150, 30));
    ...
    private void caddbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caddbtnActionPerformed
        ...
        //data base add part
        String tid = tidbox.getText();
        String tname = tnamebox.getText();
        String tnum = tnumberbox.getText();
        String tdriv = tdrivbox.getSelectedItem().toString();
        String tdate = tdatebox.getText();
        String ttime = ttimebox.getText();
      
        
        try {
             String q = "INSERT INTO trance (tvehi,tnumber,dname,datetr,ttime) values ('"+ tname +"','"+ tnum +"','"+ tdriv +"','"+ tdate +"','"+ ttime +"')";
    ...
    private void ctableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ctableMouseClicked
        ...
        String driv = ctable.getValueAt(r, 3).toString();
         String dte = ctable.getValueAt(r, 4).toString();
          String ttimee = ctable.getValueAt(r, 5).toString();
          
           
        tidbox.setText(id);
        tnamebox.setText(name);
        tnumberbox.setText(phone);
       tdrivbox.setSelectedItem(driv);
        tdatebox.setText(dte);
        ttimebox.setText(ttimee);
    ...
    private void cupdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cupdatebtnActionPerformed
       ...
       if(x==0)
        {
            String id = tidbox.getText();
            String name = tnamebox.getText();
            String phone = tnumberbox.getText();
            String dri = tdrivbox.getSelectedItem().toString();
            String dte = tdatebox.getText();
            String time = ttimebox.getText();
                       
           
           String sql = "UPDATE trance SET tvehi = '"+ name +"' , tnumber = '"+ phone +"' , dname = '"+ dri +"' , datetr = '"+ dte +"' , ttime = '"+ time +"' where tid = '"+ id +"'";
       ...
       if(x==0)
        {
            ...
            String sql = "DELETE from trance where tid = '"+ id +"'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //serch t number t number is vehical number
         String name = sbox.getText();
        
          String sql = " Select tid,tvehi,tnumber,dname,datetr,ttime from trance where tvehi LIKE '%"+ name +"%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField tdatebox;
    private javax.swing.JComboBox<String> tdrivbox;
    private javax.swing.JTextField tidbox;
    private javax.swing.JTextField tnamebox;
    private javax.swing.JTextField tnumberbox;
    private javax.swing.JTextField ttimebox;
