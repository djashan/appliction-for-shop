 ...
 */
//id number eka dnna one addd krnna
//employe eka nisa
package swing;
...
public class sup extends javax.swing.JFrame {
    ...
    public sup() {
        initComponents();
           ...
           //page eka lord weddi mulin krna ewa methna dnn
     ...
     public void tableload()
    {
        ...
        try {
            String sql = "SELECT sid,sname,snum,sgen,prod,qty,samt,sdis,stot from supl";
    ...
    private void initComponents() {
        ...
        sqtybox = new javax.swing.JTextField();
        snamebox = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        sconbox = new javax.swing.JTextField();
        jLabel18 = new javax.swing.JLabel();
        jLabel19 = new javax.swing.JLabel();
        samountbox = new javax.swing.JTextField();
        jLabel20 = new javax.swing.JLabel();
        sdiscountbox = new javax.swing.JTextField();
        jLabel21 = new javax.swing.JLabel();
        stotbox = new javax.swing.JTextField();
        jLabel22 = new javax.swing.JLabel();
        sgenbox = new javax.swing.JComboBox<>();
        ...
        sprodbox = new javax.swing.JComboBox<>();
        ...
        getContentPane().add(sidepnel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -4, 140, 650));
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/icons8_administrator_male_48px.png"))); // NOI18N
        ...
        sqtybox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sqtyboxActionPerformed(evt);
            }
        });
        jPanel3.add(sqtybox, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, 60, 30));
        jPanel3.add(snamebox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, 270, 30));
        ...
        jPanel3.add(sconbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 270, 30));
        ...
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 310, -1, -1));
        jPanel3.add(samountbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 270, 30));

        jLabel20.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(153, 255, 255));
        jLabel20.setText("Amount");
        jPanel3.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, -1, -1));
        jPanel3.add(sdiscountbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 450, 270, 30));
        ...
        jPanel3.add(stotbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 500, 270, 30));

        jLabel22.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(153, 255, 255));
        jLabel22.setText("Total Amount");
        jPanel3.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 510, -1, -1));

        sgenbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female" }));
        jPanel3.add(sgenbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 130, -1));

        cprintbtn.setText("Print");
        jPanel3.add(cprintbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 560, -1, -1));
        ...
        jPanel3.add(caddbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, -1, -1));
        ...
        jPanel3.add(cupdatebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 560, -1, -1));
        ...
        jPanel3.add(cdelbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 560, -1, -1));
        ...
        jPanel3.add(cclerbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 560, -1, -1));

        jButton9.setText("Calculater");
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton9ActionPerformed(evt);
            }
        });
        jPanel3.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, -1, -1));
        ...
        sprodbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Munchee Nice", "Cocacola", "Maliban Mari", "Tipitip" }));
        jPanel3.add(sprodbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 310, 130, -1));
        ...
        jPanel3.add(sidbox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 130, 30));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, 420, 600));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 50, 500, 600));
    ...
    private void sqtyboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sqtyboxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sqtyboxActionPerformed
    ...
    private void caddbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caddbtnActionPerformed
        ...
        //data base add part
        String sid = sqtybox.getText();
        String sname = snamebox.getText();
        String scont = sconbox.getText();
        String sgen = sgenbox.getSelectedItem().toString();
        String spro = sprodbox.getSelectedItem().toString();
        String sqty = sqtybox.getText();
        String samunt = samountbox.getText();
        String sdis = sdiscountbox.getText();
        String stot = stotbox.getText();
        
        try {
             String q = "INSERT INTO supl (sname,snum,sgen,prod,qty,samt,sdis,stot) values ('"+ sname +"','"+ scont +"','"+ sgen +"','"+ spro +"','"+ sqty +"','"+ samunt +"','"+ sdis +"','"+ stot +"')";
    ...
    private void ctableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ctableMouseClicked
        ...
        sconbox.setText(phone);
        sgenbox.setSelectedItem(gen);
        sprodbox.setSelectedItem(pro);
        sqtybox.setText(qty);
        samountbox.setText(amt);
        sdiscountbox.setText(dis);
        stotbox.setText(tot);
    ...
    private void cupdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cupdatebtnActionPerformed
       ...
       if(x==0)
        {
            String id = sidbox1.getText();
            String name = snamebox.getText();
            String phone = sconbox.getText();
            String gen = sgenbox.getSelectedItem().toString();
            String pro = sprodbox.getSelectedItem().toString();
            String qty = sqtybox.getText();
            String amt = samountbox.getText();
            String dis = sdiscountbox.getText();
            String tot = stotbox.getText();
            
           
           String sql = "UPDATE supl SET sname = '"+ name +"' , snum = '"+ phone +"' , sgen = '"+ gen +"' , prod = '"+ pro +"' , qty = '"+ qty +"' , samt = '"+ amt +"' , sdis = '"+ dis +"' , stot = '"+ tot +"' where sid = '"+ id +"'";
       ...
       if(x==0)
        {
            ...
            String sql = "DELETE from supl where sid = '"+ id +"'";
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String prodName = sprodbox.getSelectedItem().toString().toLowerCase();
        double prodPrice = 0;
        double discountPer = 10;
        int itemQty = Integer.parseInt(sqtybox.getText());
        double initAmount;
        ...
        samountbox.setText(String.valueOf(initAmount));
        sdiscountbox.setText(String.valueOf(discountAmount));
        stotbox.setText(String.valueOf(totalAmount));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         String name = sbox.getText();
          ...
          String sql = " Select sid, sname,snum,sgen,prod,qty,samt,sdis,stot from supl where sname LIKE '%"+ name +"%'";
    ...
    private void cclerbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cclerbtnActionPerformed
        ...
        snamebox.setText("");
        sconbox.setText("");
        sgenbox.setSelectedItem("");
        sprodbox.setSelectedItem("");
        sqtybox.setText("");
        samountbox.setText("");
        sdiscountbox.setText("");
        stotbox.setText("");
    ...
    private javax.swing.JTextField samountbox;
    private javax.swing.JTextField sbox;
    private javax.swing.JTextField sconbox;
    private javax.swing.JTextField sdiscountbox;
    private javax.swing.JComboBox<String> sgenbox;
    private javax.swing.JTextField sidbox1;
    private javax.swing.JPanel sidepnel;
    private javax.swing.JTextField snamebox;
    private javax.swing.JComboBox<String> sprodbox;
    private javax.swing.JTextField sqtybox;
    private javax.swing.JTextField stotbox;
